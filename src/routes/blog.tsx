    ...
    <Layout activeLabel="Blogs">
      ...
      <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 px-4 overflow-hidden border-b border-pink-100/60 bg-gradient-to-b from-[#FFF6FA] via-[#FFF8FD] to-[#EAF4FF]">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10 space-y-5">
          ...
          {/* Body Text */}
          <p className="text-[#475569] text-sm sm:text-base md:text-lg max-w-2xl mx-auto font-['Manrope',sans-serif] leading-relaxed">
          ...
          <div className="flex items-center justify-center gap-2 text-xs sm:text-sm font-semibold text-slate-500">
            ...
            <span className="text-[#172554] font-bold">Blogs</span>
          </div>
          ...
          <div className="pt-3 max-w-2xl mx-auto">
            <div className="relative flex items-center">
              <input
                ...
                className="w-full px-5 py-4 pl-12 pr-10 rounded-full bg-white/95 backdrop-blur-xl text-[#172554] placeholder:text-slate-400 shadow-[0_10px_30px_rgba(23,37,84,0.06)] border border-pink-200 focus:outline-none focus:ring-2 focus:ring-[#F45B8A] transition-all text-sm sm:text-base"
              />
            ...
            <div>
              ...
              {filteredPosts.length > 0 && (
                <p className="text-xs md:text-sm text-slate-500 mt-1 font-['Manrope',sans-serif]">
                  ...
                  <span className="font-bold text-[#F45B8A]">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative aspect-[16/10] overflow-hidden bg-slate-100">
                      ...
                      <span className="absolute top-3.5 left-3.5 bg-[#172554]/90 backdrop-blur-md text-white text-[11px] font-bold px-3.5 py-1 rounded-full shadow-sm">
                        {category}
                      </span>
                    ...
                    <div className="p-6 sm:p-7 flex-1 flex flex-col justify-between space-y-4">
                      <div>
                        {/* Title */}
                        <h3 className="font-['DM_Serif_Display',Georgia,serif] text-xl font-normal text-[#172554] group-hover:text-[#F45B8A] transition-colors leading-snug line-clamp-2">
                          {p.title}
                        </h3>

                        {/* Metadata */}
                        <div className="mt-3 flex items-center gap-3 text-xs text-slate-500 font-medium font-['Manrope',sans-serif]">
