...
export default function ScientificEvidenceHub() {
  ...
  const categories = ["All", "Neuroscience", "Biochemistry", "Obstetrics", "Epigenetics", "Ayurvedic Science", "Medical Consensus"];

  const filteredItems = SCIENTIFIC_EVIDENCE_ITEMS.filter((item) => {
      ...
      <main className="pt-24 md:pt-28 pb-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-6">
          <nav className="flex items-center gap-2 text-xs text-slate-500">
            ...
            <span className="font-semibold text-[#172554]">Scientific Evidence & Research</span>
          </nav>
        </div>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center relative z-10 space-y-4">
            ...
            <div className="pt-6 max-w-2xl mx-auto">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search by topic, keyword (e.g. music, cortisol, yoga, nutrition, sleep)..."
                  value={searchQuery}
        ...
        <section className="py-12 md:py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="mt-5 pt-4 border-t border-pink-100/70 flex flex-col sm:flex-row gap-2">
                  ...
                  <button
                    ...
                    title="Download Official Clinical Whitepaper (PDF/HTML)"
          ...
          {filteredItems.length === 0 && (
            <div className="text-center py-16 bg-white/60 rounded-3xl border border-pink-100 p-8">
              <p className="text-sm text-slate-500">No scientific evidence articles found matching your criteria.</p>
              <button
                onClick={() => {
                  setSelectedCategory("All");
                  setSearchQuery("");
                }}
                className="mt-4 px-4 py-2 bg-[#EA3484] text-white rounded-xl text-xs font-bold"
              >
                Reset Filters
              </button>
            </div>
