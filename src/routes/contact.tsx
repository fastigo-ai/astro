...
const contactCards = [
  ...
  },
  {
    ...
    info: "+91 92052 55631",
    link: "https://wa.me/919205255631?text=Hello%20Astro%20Baby%20Team,%20I%20would%20like%20to%20know%20more%20about%20Garbhadhan%20Sanskar.",
  ...
  },
  {
    ...
    subtitle: "Astro Baby Vedic Care Center",
    info: "Flat No. 5, Block B, Pocket 3, Sector G 2 & G 6, Narela, Delhi",
    link: "https://maps.google.com/?q=Flat+number+5,+block+B,+pocket+3,+sector+G+2+and+G+6,+Narela,+Delhi",
    badge: "Delhi, India",
      ...
      <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden border-b border-pink-100/60 bg-gradient-to-b from-[#FFF6FA] via-[#FFF8FD] to-[#EAF4FF]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#172554] tracking-tight leading-[1.25] md:leading-[1.2] max-w-4xl mx-auto py-1"
          >
            Connect with{" "}
