      ...
      <section className="py-8 px-4 md:px-6 max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {Array.from({ length: 6 }).map((_, i) => (
            <div
              key={i}
              className="bg-white/90 backdrop-blur-md rounded-3xl overflow-hidden border border-slate-100/80 shadow-xs p-4 space-y-4"
            >
      ...
      <section className="py-12 px-4 md:px-6 max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {Array.from({ length: 3 }).map((_, i) => (
            <div
              key={i}
              className="p-6 bg-white/90 backdrop-blur-md rounded-3xl border border-slate-100/80 shadow-xs space-y-4"
            >
